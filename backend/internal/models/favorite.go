...
type Favorite struct {
	...
	ArtistID *uint `gorm:"uniqueIndex:idx_user_artist;check:favorite_single_target,((media_id IS NULL) <> (artist_id IS NULL))" json:"artist_id,omitempty"`
	...
	Artist    *Artist   `gorm:"constraint:OnUpdate:CASCADE,OnDelete:CASCADE" json:"artist,omitempty"`
